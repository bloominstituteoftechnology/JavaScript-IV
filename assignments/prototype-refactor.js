...
class GameObject {
  ...
  */
  ...
  class Hero extends Humanoid {
      ...
      defend() {
          console.log(`${this.name} fights back with ${this.weapons}.`);
      }
  }
  ...
  class Villain extends Humanoid {
      ...
      threaten() {
          console.log(`${this.name} threatens to kill in ${this.language} with ${this.weapons}.`);
      }
  };
  ...
  */
  ...
  console.log(demon.threaten()); //Ablis threatens to kill in every language with the Four Powers.
  console.log(king.defend()); //Tarlos fights back with the Power of Space.
