...
// ===============Refactor GameObject to use class===============
class GameObject2 {
...
// ===============Refactor CharacterStats to use class===============
...
// ===============Refactor Humanoid to use class===============
...
const mage = new Humanoid2(new Date(), 'Bruce', { length: 2, width: 1, height: 1 }, 5, 'Mage Guild', ['Staff of Shamalama'], 'Common Tongue');
const swordsman = new Humanoid2(new Date(), 'Sir Mustachio', { length: 2, width: 2, height: 2 }, 15, 'The Round Table', ['Giant Sword', 'Shield'], 'Common Tongue');
const archer = new Humanoid2(new Date(), 'Lilith', { length: 2, width: 1, height: 1 }, 10, 'Forest Kingdom', ['Bow', 'Dagger'], 'Elvish');
