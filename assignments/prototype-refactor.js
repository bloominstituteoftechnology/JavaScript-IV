...
class Hero extends Humanoid {
  constructor(heroOptions) {
    super(heroOptions);
    this.hero = heroOptions.hero;
  }
  // checkIfHero() {
  //   return `${this.name} is a superhero`;
  // }
}

class Villan extends Humanoid {
  constructor(villanOptions) {
    super(villanOptions);
    this.villan = villanOptions.villan;
  }
}
...
console.log(superMan.hero);

console.log(slenderMan);
