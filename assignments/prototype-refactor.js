...
class Hero extends Humanoid {
  ...
  smite() {
    return `${this.name} shouts \"${this.catchphrase}\" and attacks with ${
      this.attack
...
class Villain extends Humanoid {
  ...
  lunge() {
    return `${this.name} shrieks \"${this.catchphrase}\" and lunges with ${
      this.attack
    }. ${this.name} does ${this.damage} points of damage.`;
  }
}
...
console.log(badGuy.lunge());
console.log(goodGuy.smite());
