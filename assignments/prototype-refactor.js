...
[x]1. Copy and paste your code or the solution from yesterday

[x]2. Your goal is to refactor all of this code to use ES6 Classes. The console.log() statements should still return what is expected of them.
...
// base class
class GameObject{
    // contructor(blueprint for the class)
