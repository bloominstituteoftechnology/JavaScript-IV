...
console.log(
  "<---------------------Stretch Create Grade Prop--------------------->"
);

console.log(Student1.grade);

console.log(
  "<---------------------Stretch Create Method for Changing Students Grade Project Manager--------------------->"
);
ProjectManager1.changeGrade(Student1);
console.log(Student1.grade);
console.log(
  "<---------------------Stretch Create Method for Changing Students Instructor--------------------->"
);
Instructor1.changeGrade(Student1);
console.log(Student1.grade);

console.log(
  "<---------------------Stretch Create Method for Graduation Via PM--------------------->"
);
ProjectManager1.graduate(Student1);

console.log(
  "<---------------------Stretch Create Method for Graduation Via Instructor--------------------->"
);
